...
@Component({
  selector: 'sx-add-soldet-dialog',
  templateUrl: './add-soldet-dialog.component.html',
  styles: [`
    .exis-form {
      width: 550px;
    }
...
export class AddSoldetDialogComponent implements OnInit, OnDestroy {
  ...
  constructor(
    public dialogRef: MdDialogRef<AddSoldetDialogComponent>,
