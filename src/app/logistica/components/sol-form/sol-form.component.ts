...
import { AddSoldetDialogComponent } from './add-soldet-dialog.component';


@Component({
  selector: 'sx-sol-form',
  templateUrl: 'sol-form.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class SolFormComponent implements OnInit {
  ...
  insertar() {
    if (this.atiende()) {
      const dialogRef = this.dialog.open(AddSoldetDialogComponent, {
