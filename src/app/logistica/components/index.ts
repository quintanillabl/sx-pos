...
export { MovimientoDetGridComponent } from './movimientodet-grid/movimientodet-grid.component';
...
export { DecdetGridComponent } from './decdet-grid/decdet-grid.component';
export { DecFormComponent } from './dec-form/dec-form.component';
