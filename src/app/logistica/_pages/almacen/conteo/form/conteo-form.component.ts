...
export class ConteoFormComponent implements OnInit, OnChanges {
  ...
  buildForm() {
    this.form = this.fb.group({
      ...
      auditor1: ['', [Validators.required, Validators.maxLength(100)]],
      auditor2: ['', [Validators.required, Validators.maxLength(100)]],
      contador1: ['', [Validators.required, Validators.maxLength(100)]],
      contador2: ['', [Validators.required, Validators.maxLength(100)]],
      capturista: ['', [Validators.required, Validators.maxLength(100)]],
  ...
  insertar() {
    const dialogRef = this.dialog.open(ConteoDetDialogComponent, {
