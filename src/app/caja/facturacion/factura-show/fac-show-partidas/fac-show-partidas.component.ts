...
@Component({
  selector: 'sx-fac-show-partidas',
  templateUrl: './fac-show-partidas.component.html',
  styleUrls: ['./fac-show-partidas.component.scss']
})
export class FacShowPartidasComponent implements OnInit {
